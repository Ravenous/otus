...
%>
	...
	<form id="form1" action="<%=(submit != null)?submit.getNext():""%>" method="POST" data-ajax="false" enctype="multipart/form-data">
			...
			<div data-role="fieldcontain">
	        	<label for="msisdn"><%=webForm.getL18nLabel("msisdn", mySession, "mainMenu:msisdn") %></label>
	        	<input type="text" name="msisdn" id="msisdn" required minlength="10" value="<%=mySession.getVariableFieldValue("msisdn")%>"  />
			</div>			
