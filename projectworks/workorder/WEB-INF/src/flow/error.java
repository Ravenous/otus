 ...
 */
public class error extends com.avaya.sce.runtime.Form {
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.PromptRefInfo("error", ""));
	...
	public com.avaya.sce.runtime.html.genmodel.WebForm getWebForm(com.avaya.sce.runtimecommon.SCESession mySession){
		...
		webForm.addElement(new com.avaya.sce.runtime.html.genmodel.TextDisplay("error", com.avaya.sce.runtime.html.genmodel.TextDisplay.NameType.CONST));
		return(webForm);
	}
}
