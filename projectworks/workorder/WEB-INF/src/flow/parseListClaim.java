 ...
 */
public class parseListClaim extends com.avaya.sce.runtime.BasicServlet {
	...
	public java.util.Collection getBranches(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		aGoto = new com.avaya.sce.runtime.Goto("chkListClaim", 0, true, "Default");
		list.add(aGoto);
