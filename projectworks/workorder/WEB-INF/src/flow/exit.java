 ...
 * Last generated by Orchestration Designer at: 20 ИЮЛЯ 2020 Г. 18:01:39 MSK
 */
public class exit extends com.avaya.sce.runtime.Return {
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.PromptRefInfo("farewell", ""));
	...
	public com.avaya.sce.runtime.html.genmodel.WebForm getWebForm(com.avaya.sce.runtimecommon.SCESession mySession){
		...
		webForm.addElement(new com.avaya.sce.runtime.html.genmodel.TextDisplay("farewell", com.avaya.sce.runtime.html.genmodel.TextDisplay.NameType.CONST));
		return(webForm);
	}
}
