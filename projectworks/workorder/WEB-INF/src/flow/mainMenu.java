 ...
 * Last generated by Orchestration Designer at: 20 ИЮЛЯ 2020 Г. 18:15:58 MSK
 */
public class mainMenu extends com.avaya.sce.runtime.Menu {
	...
	public java.util.Collection getChoices(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		choice = new com.avaya.sce.runtime.html.genmodel.MenuChoiceInput("listClaim", "listClaim", "", "mainMenu:listClaim", com.avaya.sce.runtime.html.genmodel.ChoiceInput.ChoiceType.TEXTSET, "onListClaim", "", "");
		list.add(choice);

		choice = new com.avaya.sce.runtime.html.genmodel.MenuChoiceInput("listMyClaim", "listMyClaim", "", "mainMenu:listMyClaim", com.avaya.sce.runtime.html.genmodel.ChoiceInput.ChoiceType.TEXTSET, "onListMyClaim", "", "");
		list.add(choice);

		choice = new com.avaya.sce.runtime.html.genmodel.MenuChoiceInput("getClaim", "getClaim", "", "mainMenu:getClaim", com.avaya.sce.runtime.html.genmodel.ChoiceInput.ChoiceType.TEXTSET, "onTakeClaim", "", "");
		list.add(choice);

		choice = new com.avaya.sce.runtime.html.genmodel.MenuChoiceInput("closeClaim", "closeClaim", "", "mainMenu:closeClaim", com.avaya.sce.runtime.html.genmodel.ChoiceInput.ChoiceType.TEXTSET, "onGetMyInWorkClaim", "", "");
		list.add(choice);

		choice = new com.avaya.sce.runtime.html.genmodel.MenuChoiceInput("exitApp", "exitApp", "", "mainMenu:farewell", com.avaya.sce.runtime.html.genmodel.ChoiceInput.ChoiceType.TEXTSET, "exit", "", "");
		list.add(choice);
