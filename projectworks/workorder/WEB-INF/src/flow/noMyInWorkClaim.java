 ...
 * Last generated by Orchestration Designer at: 20 ИЮЛЯ 2020 Г. 19:55:56 MSK
 */
public class noMyInWorkClaim extends com.avaya.sce.runtime.Form {
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.PromptRefInfo("noMyClaim", ""));
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("onMainMenu");
		return submit;
	}
	/**
	 ...
	 * by the code generator based on items in the call flow editor.
	 * This method should not be manually edited as changes may be
	 * overwritten by the code generator.  <br>Last generated by Orchestration Designer at: 21 ИЮЛЯ 2020 Г. 17:24:17 MSK
	 */
	...
	/**
	 * Returns a WebForm object which contains data for web elements.
	 * Last generated by Orchestration Designer at: 21 ИЮЛЯ 2020 Г. 17:24:17 MSK
	 */
	public com.avaya.sce.runtime.html.genmodel.WebForm getWebForm(com.avaya.sce.runtimecommon.SCESession mySession){
		com.avaya.sce.runtime.html.genmodel.WebForm webForm= new com.avaya.sce.runtime.html.genmodel.WebForm();
		webForm.addElement(new com.avaya.sce.runtime.html.genmodel.TextDisplay("noMyClaim", com.avaya.sce.runtime.html.genmodel.TextDisplay.NameType.CONST));
		return(webForm);
	}
}
