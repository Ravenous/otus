 ...
 * Last generated by Orchestration Designer at: 20 ИЮЛЯ 2020 Г. 22:27:58 MSK
 */
public class getMsisdn extends com.avaya.sce.runtime.Form {
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("setMsisdn");
		return submit;
	}
	/**
	...
	public com.avaya.sce.runtime.html.genmodel.WebForm getWebForm(com.avaya.sce.runtimecommon.SCESession mySession){
		...
		webForm.addElement(new com.avaya.sce.runtime.html.genmodel.TextInput("msisdn", "mainMenu:msisdn", "text", "Yes", "10", ""));
		return(webForm);
	}
}
